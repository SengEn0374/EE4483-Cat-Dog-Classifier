...
def cat_dog_trainer(args):
    ...
    for epoch in range(start_epoch, args.max_epoch):
        f.write(f'Epoch: {epoch}/{args.max_epoch-1}\n')
...
def parse_args():
    ...
    parser.add_argument('--save_dir', default='./checkpoints/test', help='directory to save models.')
    parser.add_argument('--data_dir', default='../datasets', help='training data directory')
    ...
    parser.add_argument('--max_epoch', type=int, default=50, help='max training epoch')
